    ...
    class Program
    {
        static void Main(string[] args)
        {
          Console.WriteLine("***Composite Pattern Demo ***");
            ...
            CarComposite carComponent = new CarComposite(1000, 100000, "Plastic", "White", "Hyundai Tucson");



            WheelComposite wheelComponent = new WheelComposite(5, 1000, 1);

            BrakeComposite breakComponent = new BrakeComposite(6, 500, "Ceramic", "Neon");

            Screw grayScrew = new Screw(1, 1, "gray");
            Screw greenScrew = new Screw(1, 1, "Green");
            Screw redScrew = new Screw(1, 1, "Red");

            breakComponent.Add(grayScrew);
            breakComponent.Add(grayScrew);
            breakComponent.Add(redScrew);

            wheelComponent.Add(grayScrew);
            wheelComponent.Add(grayScrew);
            wheelComponent.Add(grayScrew);
            wheelComponent.Add(grayScrew);
            wheelComponent.Add(greenScrew);
            wheelComponent.Add(breakComponent);

            carComponent.Add(wheelComponent);
            carComponent.Add(wheelComponent);
            carComponent.Add(wheelComponent);
            carComponent.Add(wheelComponent);

            carComponent.PrintComponentInfo();
